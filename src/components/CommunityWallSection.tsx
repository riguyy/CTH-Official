    ...
    <section id="community" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#F5EFE6] text-slate-800 relative">
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Share & Hashtags Card */}
          <div className="bg-white p-6 rounded-2xl border border-amber-200/80 shadow-sm hover:shadow-md transition-all space-y-4 flex flex-col justify-between sm:col-span-2 lg:col-span-1">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-amber-100 text-amber-800 flex items-center justify-center font-bold text-sm shadow-sm border border-amber-200">
                  <Sparkles className="w-5 h-5 text-amber-700" />
                </div>
                <div>
                  <h3 className="font-serif-title text-xl font-bold text-slate-900">Official Hashtags</h3>
                  <p className="text-xs text-slate-500 font-sans-body">Share Your Story</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-1.5 text-[11px] font-sans-body text-amber-900 font-medium pt-1">
                <span className="px-2.5 py-1 rounded-lg bg-amber-50 border border-amber-200">#ClimbingTowardHealing</span>
                <span className="px-2.5 py-1 rounded-lg bg-amber-50 border border-amber-200">#HealingJourney</span>
                <span className="px-2.5 py-1 rounded-lg bg-amber-50 border border-amber-200">#FindingLight</span>
                <span className="px-2.5 py-1 rounded-lg bg-amber-50 border border-amber-200">#KeepClimbing</span>
                <span className="px-2.5 py-1 rounded-lg bg-amber-50 border border-amber-200">#YouAreNotAlone</span>
              </div>
            </div>

            <p className="text-[11px] text-slate-500 italic">
              Tag us in your photos of the book to be featured on Jacqueline's official stories!
            </p>
          </div>
